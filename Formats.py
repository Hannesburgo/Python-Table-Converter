...
class Formats:
    ...
    def appendInfo(self, formatID, id, size, color, lapidation):
        self.formats[self.dictionary[formatID]].append([id, size, self.dictionary[color], self.dictionary[lapidation]])
