    ...
    def buildNewTableInfo(self, variations):
        ...
        # Retrive all variations of the currently iterable Format, and repeat for each one of them.
            ...
            for info in variationInfo:
                ...
                None, None, None, self.motherStoneSignature, None, None, None, None, None, 0, "Formato", formats, 1, 1, "Cor", 
                info[2], 1, 1, "Tamanho", info[1], 1, 1, "Lapidação", self.lapidation, 1, 1])
